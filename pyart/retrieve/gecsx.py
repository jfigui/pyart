...
def visibility_processing(radar, radar_specs, dem_grid,
                         fill_value = None, 
    ...
    visib_map, minviselev_map = gf.visibility(az_map, range_map, elev_map, 
                    res_dem, xmin_dem, ymin_dem, dr, daz,
                    rad_x, rad_y, verbose)
    ...
    rcs_pol =  gf.rcs(az_map, elev_map, range_map, effarea_map, sigma0_map,
                         visib_map, elevations, res_dem, xmin_dem, ymin_dem, 
                         rad_x, rad_y, range_pol, azimuths_pol, 
    ...
    vispol =  gf.visibility_angle(minviselev_map, az_map, range_map,
                                  elevations, res_dem, xmin_dem, ymin_dem,
                                  rad_x, rad_y, range_pol, azimuths_pol, 
                                  radar_specs['beamwidth'], radar_specs['tau'], 
                                  az_conv, verbose)
    ...
    if not return_pyart_objects:  
        ...
        logging.info('Adding polar fields to input Radar (DEM) object...')
